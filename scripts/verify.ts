...
const BASE_ADDRESS = "0xC5Ab2eff958038aD58e541290781B5d9859d16c7";
const ETH_ADDRESS  = "0x3BaeC7006BA6922c6B885D774B76557a66627B26";
...
async function main() {
  ...
  await hre.run("verify:verify", {
    ...
    constructorArguments: [
      ...
      "0x3BaeC7006BA6922c6B885D774B76557a66627B26", // ethShadowBridge
  ...
  await hre.run("verify:verify", {
    ...
    constructorArguments: [
      ...
      "0xC5Ab2eff958038aD58e541290781B5d9859d16c7", // baseShadowBridge
    ],
  });
